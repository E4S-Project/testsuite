...
execute_process(
  COMMAND "/usr/bin/git" --git-dir=.git show-ref "development"
  WORKING_DIRECTORY "/home/ubuntu/testsuite/validation_tests/amrex-cuda/build/_deps/amrex-src"
...
elseif(show_ref_output MATCHES "^[a-z0-9]+[ \\t]+refs/tags/")
  ...
  get_hash_for_ref("development" tag_sha error_msg)
...
elseif(show_ref_output MATCHES "^[a-z0-9]+[ \\t]+refs/heads/")
  ...
  elseif(tag_sha STREQUAL "")
    ...
    if(NOT can_fetch)
      message(FATAL_ERROR
        "Requested git ref \"development\" is not present locally, and not "
...
if(git_update_strategy STREQUAL "CHECKOUT")
  ...
  if(error_code)
    ...
    if(NOT git_update_strategy STREQUAL "REBASE_CHECKOUT")
      ...
      message(FATAL_ERROR "\nFailed to rebase in: '/home/ubuntu/testsuite/validation_tests/amrex-cuda/build/_deps/amrex-src'."
...
if(need_stash)
  ...
  if(error_code)
    ...
    if(error_code)
      ...
      message(FATAL_ERROR "\nFailed to unstash changes in: '/home/ubuntu/testsuite/validation_tests/amrex-cuda/build/_deps/amrex-src'."
                          "\nYou will have to resolve the conflicts manually")
    endif()
  endif()
endif()
