...
c---------------------------------------------------------------------
      ...
      call setup()
      call compute_indexmap(twiddle, dims(1,3))
...
c---------------------------------------------------------------------
      ...
      do iter = 1, niter
         ...
         call evolve(u0, u1, twiddle, dims(1, 1))
...
c---------------------------------------------------------------------
      ...
      subroutine evolve(u0, u1, twiddle, d)
...
c---------------------------------------------------------------------
      ...
      double precision twiddle(d(1),d(2),d(3))
      integer i, j, k
...
c---------------------------------------------------------------------
 ...
 1000 format(//,' NAS Parallel Benchmarks 3.1 -- FT Benchmark',/)
...
c---------------------------------------------------------------------
      ...
      subroutine compute_indexmap(twiddle, d)
...
c---------------------------------------------------------------------
      ...
      double precision ap, twiddle(d(1), d(2), d(3))
