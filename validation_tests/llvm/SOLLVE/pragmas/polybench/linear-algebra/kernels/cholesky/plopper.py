...
class Plopper:
    ...
    def findRuntime(self, x, params):
        ...
        util_dir   = kernel_idx +  "../../../utilities/"

        cmd1 = "clang -fno-caret-diagnostics "  +interimfile +" " + kernel_dir + "/polybench.c" \
                + " -I" + kernel_dir + \
                " -DEXTRALARGE_DATASET -DPOLYBENCH_TIME -std=c99 -fno-unroll-loops -O3 -mllvm -polly -mllvm -polly-process-unprofitable -mllvm -polly-use-llvm-names -ffast-math -march=native -o "+tmpbinary
