...
p0= CSH.CategoricalHyperparameter(name='p0', choices=["#pragma clang loop(j) pack array(A) allocate(malloc)", " "], default_value=' ')
p1= CSH.CategoricalHyperparameter(name='p1', choices=["#pragma clang loop(i) pack array(A) allocate(malloc)", " "], default_value=' ')
