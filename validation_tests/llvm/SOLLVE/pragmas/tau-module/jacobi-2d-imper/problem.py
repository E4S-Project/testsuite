...
p0= CSH.CategoricalHyperparameter(name='p0', choices=["#pragma clang loop(ik1) pack array(A) allocate(malloc)", "#pragma clang loop(ik1) pack array(B) allocate(malloc)", " "], default_value=' ')
p1= CSH.CategoricalHyperparameter(name='p1', choices=["#pragma clang loop(jk1) pack array(A) allocate(malloc)", "#pragma clang loop(jk1) pack array(B) allocate(malloc)", " "], default_value=' ')

p2= CSH.CategoricalHyperparameter(name='p2', choices=["#pragma clang loop(ik2) pack array(A) allocate(malloc)", "#pragma clang loop(ik2) pack array(B) allocate(malloc)", " "], default_value=' ')
p3= CSH.CategoricalHyperparameter(name='p3', choices=["#pragma clang loop(jk2) pack array(A) allocate(malloc)", "#pragma clang loop(jk2) pack array(B) allocate(malloc)", " "], default_value=' ')
