...
p0= CSH.CategoricalHyperparameter(name='p0', choices=["#pragma clang loop vectorize", " "], default_value=' ')
p1= CSH.CategoricalHyperparameter(name='p1', choices=["#pragma clang loop vectorize", " "], default_value=' ')



p0= CSH.CategoricalHyperparameter(name='p0', choices=["#pragma clang loop(j2) pack array(A) allocate(malloc)", "#pragma clang loop(j2) pack array(B) allocate(malloc)", " "], default_value=' ')
p1= CSH.CategoricalHyperparameter(name='p1', choices=["#pragma clang loop(i1) pack array(A) allocate(malloc)","#pragma clang loop(i1) pack array(B) allocate(malloc)", " "], default_value=' ')
